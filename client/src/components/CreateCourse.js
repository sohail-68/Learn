...
const CreateCourse = () => {
  ...
  const [imagePreview, setImagePreview] = useState(
    existingCourse.courseThumbnail
      ? `https://learn-rd8o.onrender.com/${existingCourse.courseThumbnail.replace(/\\/g, '/')}`
      : null
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await axios.put(`https://learn-rd8o.onrender.com/api/courses/${existingCourse._id}`, formData, {
          headers: {
        ...
        // Create new course
        await axios.post('https://learn-rd8o.onrender.com/api/courses', formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
